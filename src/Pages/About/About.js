...
const About = () => {
    return (
      ...
      <div className="mx-auto mb-10 lg:max-w-xl sm:text-center">
        <p className="inline-block px-3 py-px mb-4 text-5xl font-semibold tracking-wider text-gray-200  uppercase rounded-full bg-teal-accent-400">
          Discover Our Team
        </p>
        <p className="text-base text-white md:text-lg">
          Here our Best photographer
        </p>
      </div>
